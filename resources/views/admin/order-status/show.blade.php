            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('admin/orderstatus' . '/' . $orderstatus->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Title </th><td> {{ $orderstatus->title }} </td></tr><tr><th> Status </th><td> {{ $orderstatus->status }} </td></tr>
                                </tbody>
                            </table>
                        </div>
